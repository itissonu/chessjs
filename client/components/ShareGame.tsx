...
export const ShareGame = ({ className, gameId, isFriendGame }: { className?: string, gameId: string, isFriendGame: boolean }) => {
    ...
    return (
        <div className={`flex flex-col items-center gap-y-4 ${className}`}>
            ...
            <div className="flex items-center gap-x-2">
                ...
                <div onClick={handleCopy} className="text-blue-500 cursor-pointer h-max border-[1px] shadow bg-green-100 p-2 rounded-md">
                    {url}
                </div>
            </div>
